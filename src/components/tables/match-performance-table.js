                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="right">
                                            {row.set1_position === 7 ? 'L' : row.set1_position === 8 ? '*' : row.set1_position}
                                        </TableCell>
                                        <TableCell align="right">
                                            {row.set2_position === 7 ? 'L' : row.set2_position === 8 ? '*' : row.set2_position}
                                        </TableCell>
                                        <TableCell align="right">
                                            {row.set3_position === 7 ? 'L' : row.set3_position === 8 ? '*' : row.set3_position}
                                        </TableCell>
                                        <TableCell align="right">
                                            {row.set4_position === 7 ? 'L' : row.set4_position === 8 ? '*' : row.set4_position}
                                        </TableCell>
                                        <TableCell align="right">
                                            {row.set5_position === 7 ? 'L' : row.set5_position === 8 ? '*' : row.set5_position}
                                        </TableCell>
